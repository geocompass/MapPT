 ...
 */
class A0Vertical extends BaseTemplate {
  constructor(props = 'A0VerticalDefault') {
    super();
    this.canvas = new createCanvas(9933, 14041);
   ...
   * @param {number} [paramObject.left=2921] - 图幅字体相对左边距
   * @param {number} [paramObject.top=319] - 图幅字体相对上边距
   ...
   * @param {number} [paramObject.top=13803] - 主编单位字体相对上边距
   ...
   * @param {number} [paramObject.left=4000] - 比例尺数值字体相对左边距
   * @param {number} [paramObject.top=13812] - 比例尺数值字体相对上边距
   ...
   * @param {number} [paramObject.left=4971] - 比例尺图示相对左边距
   * @param {number} [paramObject.top=13869] - 比例尺图示相对上边距
   ...
   * @param {number} [paramObject.left=6816] - 承编单位字体相对左边距
   * @param {number} [paramObject.top=13799] - 承编单位字体相对上边距
